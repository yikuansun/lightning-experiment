function renderLightning(indent=150, twitchAmount=169, twitchScale=0.004, twitchOctaves=20, twitchSeed=8, numBranches=5, branchLen=300, branchAngle=0.785, branchLenDelta=50, coreSize=4, coreColor="#FFFFFF", softness=4, glowRadius=8, glowColor="#00BBFF") {
